...
class FreelanceDetails extends StatefulWidget {
  final QueryDocumentSnapshot<Map<String, dynamic>> data;
  final String id;
  const FreelanceDetails({Key? key, required this.data, required this.id}) : super(key: key);

  @override
  State<FreelanceDetails> createState() => _FreelanceDetailsState();
}

class _FreelanceDetailsState extends State<FreelanceDetails> {
  @override
          ...
          MaterialButton(
              onPressed: (){
                if(Hive.box('user').get('phone') == '' || Hive.box('user').get('phone') == null){
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => FreelanceEntry(id: widget.id,data: widget.data,)));
                }
              },
