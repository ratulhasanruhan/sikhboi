...
class ContestsEntry extends StatefulWidget {
  final String id;
  final QueryDocumentSnapshot<Map<String, dynamic>> data;
  ContestsEntry({super.key, required this.id, required this.data});

  @override
  State<ContestsEntry> createState() => _ContestsEntryState();
}

class _ContestsEntryState extends State<ContestsEntry> {
